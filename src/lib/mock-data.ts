...
export const shifts: Shift[] = [
  ...
  { id: "sh3b", source: "bokun", bookingId: "BKN-48298", tourName: "Trastevere Food & Bike Tour", date: today, startTime: "11:00", endTime: "14:30", meetingPoint: "Piazza Trilussa", customer: { name: "Emma Johnson", phone: "+44 7700 900123" }, participants: { adults: 5, teens: 0, infants: 0, trailers: 0 }, rate: 325, notes: "Gluten-free guest", assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "kids tour"] },
  { id: "sh3c", source: "bokun", bookingId: "BKN-48301", tourName: "Private Vatican Tour", date: today, startTime: "15:30", endTime: "18:30", meetingPoint: "Via della Conciliazione", customer: { name: "Yuki Sato", phone: "+81 80 9876 5432" }, participants: { adults: 2, teens: 0, infants: 0, trailers: 0 }, rate: 380, notes: "VIP — Japanese-speaking guide preferred", assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "Vatican tour", "private tour"] },
  ...
  { id: "sh5b", source: "bokun", bookingId: "BKN-48325", tourName: "Colosseum Morning E-Bike Tour", date: tomorrow, startTime: "09:00", endTime: "12:00", meetingPoint: "Piazza Venezia, Rome", customer: { name: "Carlos Ruiz", phone: "+34 600 112233" }, participants: { adults: 8, teens: 0, infants: 0, trailers: 0 }, rate: 480, notes: "Spanish-speaking group", assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "Colosseum tour"] },
  { id: "sh5c", source: "manual", tourName: "Rental desk — morning", date: tomorrow, startTime: "09:00", endTime: "13:00", meetingPoint: "Shop — Via del Corso", assignedStaffId: null, status: "unassigned", requiredTags: ["rental desk"] },
  { id: "sh5d", source: "bokun", bookingId: "BKN-48330", tourName: "Kids & Family E-Bike Tour", date: tomorrow, startTime: "10:30", endTime: "13:00", meetingPoint: "Villa Borghese", customer: { name: "Sophie Laurent", phone: "+33 6 99 88 77 66" }, participants: { adults: 2, teens: 1, infants: 0, trailers: 1 }, rate: 220, notes: "2 kids age 8 and 11", assignedStaffId: "s2", status: "pending", requiredTags: ["e-bike", "kids tour"] },

  // DAY AFTER
  { id: "sh6", source: "bokun", bookingId: "BKN-48340", tourName: "Vatican Highlights E-Bike Tour", date: dayAfter, startTime: "10:00", endTime: "13:00", meetingPoint: "Castel Sant'Angelo", customer: { name: "Michael Brown", phone: "+1 415 555 0199" }, participants: { adults: 4, teens: 0, infants: 0, trailers: 0 }, rate: 240, assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "Vatican tour"] },
  { id: "sh7", source: "bokun", bookingId: "BKN-48345", tourName: "Appian Way Morning Ride", date: dayAfter, startTime: "08:30", endTime: "12:00", meetingPoint: "Porta San Sebastiano", customer: { name: "Lisa Andersson", phone: "+46 70 123 4567" }, participants: { adults: 3, teens: 1, infants: 0, trailers: 0 }, rate: 245, assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "Appian Way"] },
  { id: "sh8", source: "manual", tourName: "Fleet maintenance check", date: dayAfter, startTime: "14:00", endTime: "17:00", meetingPoint: "Workshop", notes: "Pre-weekend check on all 15 bikes", assignedStaffId: null, status: "unassigned", requiredTags: ["maintenance"] },

  // IN 3 DAYS
  { id: "sh9", source: "bokun", bookingId: "BKN-48360", tourName: "Night Rome E-Bike Tour", date: inThreeDays, startTime: "20:30", endTime: "23:00", meetingPoint: "Piazza del Popolo", customer: { name: "Tom Wilson", phone: "+44 7800 555111" }, participants: { adults: 6, teens: 0, infants: 0, trailers: 0 }, rate: 390, assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "night tour"] },
  { id: "sh10", source: "bokun", bookingId: "BKN-48362", tourName: "Colosseum & Roman Forum E-Bike Tour", date: inThreeDays, startTime: "09:30", endTime: "12:30", meetingPoint: "Piazza Venezia, Rome", customer: { name: "Anna Schmidt", phone: "+49 170 9988776" }, participants: { adults: 2, teens: 0, infants: 0, trailers: 0 }, rate: 120, assignedStaffId: "s1", status: "pending", requiredTags: ["e-bike", "Colosseum tour"] },
  { id: "sh11", source: "manual", tourName: "Rental desk — full day", date: inThreeDays, startTime: "09:00", endTime: "19:00", meetingPoint: "Shop — Via del Corso", assignedStaffId: null, status: "unassigned", requiredTags: ["rental desk"] },

  // IN 4 DAYS
  { id: "sh12", source: "bokun", bookingId: "BKN-48380", tourName: "Private Colosseum Tour", date: inFourDays, startTime: "10:00", endTime: "13:30", meetingPoint: "Piazza Venezia, Rome", customer: { name: "Robert Chen", phone: "+1 212 555 0177" }, participants: { adults: 4, teens: 0, infants: 0, trailers: 0 }, rate: 560, notes: "VIP private booking", assignedStaffId: null, status: "unassigned", requiredTags: ["e-bike", "Colosseum tour", "private tour"] },
  { id: "sh13", source: "bokun", bookingId: "BKN-48385", tourName: "Vatican Highlights E-Bike Tour", date: inFourDays, startTime: "14:30", endTime: "17:30", meetingPoint: "Castel Sant'Angelo", customer: { name: "Pierre Martin", phone: "+33 6 22 33 44 55" }, participants: { adults: 3, teens: 2, infants: 0, trailers: 0 }, rate: 275, assignedStaffId: "s6", status: "pending", requiredTags: ["e-bike", "Vatican tour"] },
];
